...
export default async function TokenDetailPage({ params }: { params: { ticker: string } }) {
  ...
  const charterRows = charter?.charter
    ? [
        ...
        { label: "Fee Split", value: `${charter.charter.feeSplitLpBps / 100}% LP / ${charter.charter.feeSplitHouseBps / 100}% House / ${charter.charter.feeSplitReferralBps / 100}% Ref` },
    ...
    : [
        ...
        { label: "Fee Split", value: "70% LP / 20% House / 10% Ref" },
